    ...
    return (
        <div>
            <div className='flex flex-row justify-between p-5 md:px-32 px-5 bg-darkBackground text-white'>
                ...
                <div className='hidden lg:flex flex-row item-center gap-4'>
            ...
            <div className={`${menu ? 'traslate-x-0' : 'translate-x-full'} lg:hidden flex flex-col absolute bg-darkBackground text-white left-0 top-20 font-semibold text-2xl text-center pt-8 pb-4 gap-8 w-full h-fit transition-transform`}>
                dropdown 
            </div>
        </div>
    )
